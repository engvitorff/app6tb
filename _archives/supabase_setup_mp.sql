...
-- Políticas de Segurança (Limpando antes de criar para evitar erros se rodar duas vezes)
DROP POLICY IF EXISTS "Users can view their own integration" ON user_integrations;
DROP POLICY IF EXISTS "Users can insert their own integration" ON user_integrations;
DROP POLICY IF EXISTS "Users can update their own integration" ON user_integrations;
DROP POLICY IF EXISTS "Users can delete their own integration" ON user_integrations;
