      ...
      <div className="space-y-3">
        ...
        {!isLoading && musicians.length === 0 && (
          <div className="bg-zinc-900/50 border border-zinc-800 border-dashed rounded-3xl p-10 text-center">
             <p className="text-zinc-600 text-sm italic">Nenhum músico cadastrado no elenco.</p>
          </div>
        )}
          ...
          <div className="bg-zinc-950 border border-zinc-800 w-full md:max-w-md rounded-t-[40px] md:rounded-[40px] p-8 shadow-2xl animate-in fade-in slide-in-from-bottom-10 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveMusician} className="space-y-6">
              <div>
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)} required placeholder="Ex: Zeca Pagodinho"
                  className="w-full h-14 mt-1 bg-zinc-900 border border-zinc-800 rounded-2xl px-5 text-white focus:ring-2 focus:ring-[#FF169B]/50 focus:outline-none transition-all placeholder:text-zinc-800 font-bold" />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={pix} onChange={e => setPix(e.target.value)} required placeholder="CPF, Email ou Celular"
                    className="w-full h-14 mt-1 bg-zinc-900 border border-zinc-800 rounded-2xl pl-12 pr-5 text-white focus:outline-none transition-all font-bold" />
                </div>
              </div>
              ...
              <div className="pt-4 flex flex-col space-y-3">
                ...
                {selectedMusician && (
                  <button 
                    type="button"
                    onClick={() => handleDeleteMusician(selectedMusician.id)}
